...
## 22:06 · DAVINCI
**Kamu:** I want to build an apps with ai agent and multiagents. The question is what kinda type of it that could make me a fuckin bilionaire and most of people dont realize it
...
## 22:09 · DAVINCI
**Kamu:** hmmm kurang menarik, cari ide lain sekarang juga !!!
...
## 22:27 · DAVINCI
**Kamu:** saya ingin membuat multiagent untuk web scrapping sosial media seperti youtube,tiktok, ig, facebook. Kira-kira adakah saran sosial media tambahan untuk di scrapping dan beri saran peran-peran dari multiagents untuk web scrapping ini !
...
## 22:31 · DAVINCI
**Kamu:** Oke, ide yang bagus. Sekarang, tolong buatkan prompt untuk semua hal diatas yang akan saya gunakan pada vs code claude dan segera saya buat multiagentnya !
...
## 22:32 · DAVINCI
**Kamu:** tolong visualisasikan bagaimana caranya ia bekerja !
...
stateDiagram-v2
    [*] --> Scout: Setiap 6 Jam
    Scout --> Harvester: Daftar Target Baru
    Harvester --> Cleaner: Data Mentah
    Cleaner --> Analyst: Data Bersih
    Analyst --> [*]: Insight & Laporan
    Analyst --> Scout: Umpan Balik untuk Target Berikutnya
```
...
## 22:38 · DAVINCI
**Kamu:** tolong berikan prompt lengkap untuk data cleanernya !
